...
echo "# {$headerText}\n\n";
echo "See [How to run](https://github.com/arxeiss/advent-of-code-2022/#how-to-run) chapter to run this puzzle\n\n";
echo "> :warning: **SPOILER ALERT** :warning: - The code contains solution for the whole task. Try first to solve it **yourself**. :link: https://adventofcode.com/2022/day/{$currentDay}\n\n";
...
file_put_contents('src/Day' . str_pad($currentDay, 2, '0', STR_PAD_LEFT) . '/README.md', ob_get_clean());
